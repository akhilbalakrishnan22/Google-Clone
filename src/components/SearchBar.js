...
function SearchBar({ hideButtons = false, termm }) {
    ...
    return (
        <div className="searchBar">
            <form>
                <div className="bar">
                    <SearchIcon id="searchIcon" color="primary" />
                    {!hideButtons ? (
                ...
                {!hideButtons ? (
                    <div className="searchButton">
                        <input id="subBut" type="submit" onClick={search} value="Google Search"></input>
                        <input id="subBut" type="button" value="I'm Feeling Lucky"></input>
                    </div>
                ) : (
                        <div className="searchButton">
